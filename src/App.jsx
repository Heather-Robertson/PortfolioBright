...
import MorphDivider from './assets/MorphDivider.jsx'
...
function Nav() {
  ...
  <nav className="nav">
    ...
    <ul className="nav-links">
      <li className="home-link"><HashLink to="/#">Home</HashLink></li>
      <li className="digital-craft-link"><HashLink to="/#digital_craft">Digital Craft</HashLink></li>
      <li className="physical-craft-link"><HashLink to="/#physical_craft">Physical Craft</HashLink></li>
      <li className="research-link"><HashLink to="/#research">Research</HashLink></li>
      <li className="playground-link"><HashLink to="/#playground">Playground</HashLink></li>
      {/* <LanguageSelector /> */}
    </ul>
  </nav>
  );
...
function Hero(){
  ...
  return(
    <section className="hero" id="home" ref={heroRef}>
      ...
      <p>I am an HCI specialist and recent graduate of the Design Engineering Master’s program at Brown University and the Rhode Island School of Design. My work centers digital and physical design as a tool for liberation, which I approach both through academic research and through the concrete practice of making.</p>
      <MorphDivider zIndex={1} colors={["#FB8467", "#1F3E87", "#00C49A", "#FB8467"]}/>
    </section>
  );
}
...
function Card({z, ref, title, subtitle, image, alt, skills}) {
  return(
...
function CardSection({z, title, sectionID, content, cards, colors}){
  return(
    <section className="card-section" id={sectionID} style={{zIndex: z}}>
      <div className="section-container">
        <div className="section-hero" style={{zIndex: 0}}>
          <h2>{title}</h2>
          <p>{content}</p>
        </div>
      ...
      <MorphDivider zIndex={z+1} colors={colors}/>
    </section>
  )
}
...
function Playground() {
  ...
  const playgroundImages = [
    ...
    {source: ThesisBoxPreview, alt: "A wooden box with intricately-engraved, interlocking lid panels", x: 80, y: 30},
...
function Home() {
  ...
  return(
    <>
      ...
      <main>
          <Hero />
          <CardSection z={1} colors={["#FFB5B4", "#FFEA00", "#1F3E87", "#00C49A"]} title="Digital Craft" sectionID="digital_craft" content="User Interface and User Experience Design, Programming, and Frontend Development" cards={digitalCards} />
          <CardSection z={2} colors={["#FFB5B4", "#FB8467", "#FFEA00", "#1F3E87"]} title="Physical Craft" sectionID="physical_craft" content="Design Engineering, Physical Computation, Handicraft, and Prototyping" cards={physicalCards} />
          <CardSection z={3} colors={["#FFB5B4", "#FB8467", "#00C49A", "#FFEA00"]} title="Research" sectionID="research" content="Applied Computer Science, Computational Design, and Computational Geometry" cards={researchCards} />
          <Playground />
      </main>
    </>
  );
